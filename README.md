...
Your challenge is to build out this time tracking dashboard page and get it looking as close to the design as possible.
...
- can change the tracking category from weekly to monthly or even daily
...
You will find all the required assets in the `/images` folder that is inside the `/src` folder. The assets are already optimized.
...
I used to write this file with [@AjeaSmith](https://github.com/AjeaSmith)
